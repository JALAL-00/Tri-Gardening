                    ...
                    <CardContent className="space-y-6 pt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                ...
                                <Input {...register(`variants.${index}.title` as const, { required: true })} placeholder="e.g. Small" className="bg-white text-black border-gray-700 h-10 focus-visible:ring-[#759C5D]" />
                            </div>
                            <div>
                                <Label className="text-gray-400 text-xs uppercase font-bold tracking-wider mb-1.5 block">Stock Alert Limit</Label>
                                <Input type="number" {...register(`variants.${index}.stockAlertLimit` as const)} placeholder="5" className="bg-white text-black border-gray-700 h-10 focus-visible:ring-[#759C5D]" />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    <Input 
                                        ...
                                        placeholder="#RRGGBB" 
                                        className="bg-white text-black border-gray-700 h-10 focus-visible:ring-[#759C5D] w-full" 
                                    />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 bg-gray-900/50 p-4 rounded-lg border border-gray-800">
                            <div>
                                <Label className="text-white text-xs font-bold mb-1.5 block">Buying Price</Label>
                                <Input type="number" {...register(`variants.${index}.buyingPrice` as const)} className="bg-white text-black border-none h-9" />
                            </div>
                            <div>
                                <Label className="text-white text-xs font-bold mb-1.5 block">Selling Price (MRP)</Label>
                                <Input type="number" {...register(`variants.${index}.price` as const, { required: true })} className="bg-white text-white border-2 border-[#759C5D] h-9 font-bold" />
                            </div>
                            <div>
                                <Label className="text- text-xs font-bold mb-1.5 block">Stock Quantity</Label>
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-white border-none shadow-lg rounded-xl">
            <CardHeader className="border-b border-gray-800 pb-3 flex flex-row justify-between items-center">
                <CardTitle className="text-gray-800 text-base">Categorization</CardTitle>
                <Button 
                    type="button" 
                    variant="ghost" 
                    size="sm" 
        ...
        <Card className="bg-white border-none shadow-lg rounded-xl">
            <CardHeader className="border-b border-gray-800 pb-3">
                <CardTitle className="text-gray-800 text-base">Status</CardTitle>
            </CardHeader>
            <CardContent className="space-y-5 pt-5">
                <div className="space-y-2">
                    <Label className="text-gray-700 text-sm">Product Status</Label>
                    <Controller
                        name="status"
                        control={control}
                        render={({ field }) => (
                ...
                <div className="flex items-center justify-between p-3 border border-gray-700 rounded-lg bg-gray-800/50">
                    <Label className="cursor-pointer text-gray-700 text-sm font-medium" htmlFor="featured">Featured Product</Label>
                    <Controller
                        name="isFeatured"
                        control={control}
                        render={({ field }) => (
